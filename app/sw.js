 ...
 */
const CACHE = 'nocase-shell-v14';  // v14: case switcher; v13: chat markdown + phone wording; v12: Ask button clears Send (v11: one folder per case on phones; new case never merges v10: chat retry + honest error; v9: explanations + precedent report (v8: flow + Ask; v7: practice; v6: kit; v5: photo fallback; v4: folder copy; v3: HEIC))
